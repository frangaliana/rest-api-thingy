...
var MyProducts = React.createClass({
    ...
    /*getProduct(product, index) {
    	return(
                 <td colSpan="2">
                    <div id={"div"+product._id} className="collapse">
                    	<Table>
                      		<thead>
                        		<th>Producto</th>
                        		<th>Precio</th>
		            ...
		            <thead>
		              <tr>
			            ...
			            <tbody key={product._id}>
				            <tr>
				               <td id={"Myproduct"+product._id} className="clickable" data-toggle="collapse" data-target={"#"+index}>{product.title}</td>
										...
										<tr>
											<td colSpan="100%"><Button bsStyle="warning" onClick={this.createProduct}>¡Adelante, sube un producto!</Button></td>
										</tr>
			  		  </Table>
